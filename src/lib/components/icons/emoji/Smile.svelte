...
<svg viewBox="0 0 91 91" class={props.class} fill="currentColor">
	...
	></path>
	<path
		d="M67.5,57.2c-3.7,1.6-6.9,3.8-10.9,4.9c-4,1.1-8.1,1.6-12.2,1.5c-8,0-15-3.2-22.3-6c-0.8-0.3-1.6,0.8-1.1,1.4 c1.3,1.6,2.4,3.2,4.1,4.4c1.9,1.3,4,2.2,6.1,3.1c4.2,1.7,8.7,2.6,13.2,2.9c4.6,0.3,9.4-0.3,13.8-1.5c4.3-1.2,9.6-2.9,12.8-6.2 C73.4,59.3,70.4,56,67.5,57.2z"
	></path>
</svg>
